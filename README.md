...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `79.1µs` | `560.9µs` |
| [Day 2](./src/bin/02.rs) | `57.6µs` | `56.0µs` |
| [Day 3](./src/bin/03.rs) | `487.9µs` | `344.9µs` |
| [Day 4](./src/bin/04.rs) | `175.3µs` | `204.5µs` |
| [Day 5](./src/bin/05.rs) | `16.9µs` | `30.3s` |
